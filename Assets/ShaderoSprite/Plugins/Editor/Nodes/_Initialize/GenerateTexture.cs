...
namespace _ShaderoShaderEditorFramework
{
    ...
    public class GenerateTexture : Node
    {
        ...
        protected internal override void NodeGUI()
        {
            ...
            if (Outputs[0].GetNodeAcrossConnection() == null) Outputs[0].knobTexture = ResourceManager.GetTintedTexture("Textures/Out_Knob.png", new Color(0.50f, 0.50f, 0.50f, 0.75f));
            else
