...
{
	[CreateAssetMenu(menuName = "AnimationFSMData/MeleeGhoulFSMData")]
	public class MeleeGhoulAnimationData : FSMData
	{
		class Anim
		{
			public const string Idle_Ground = "Idle_Ground";
			public const string Walk_Ground = "Walk_Ground";
			public const string Walk_Ground_Back = "Walk_Ground_Back";
			public const string ATK_Combo_1 = "ATK_Combo1_01";
			public const string ATK_Combo_2 = "ATK_Combo1_02";
			public const string Alert = "Alert";
			public const string Death_Ground = "Death_Ground";
			public const string Stagger_Weak = "Hitten_Small";
			public const string Stagger_Med = "Hitten_Normal";
			public const string Stagger_Strong = "Hitten_Big";
		}
		...
		public MeleeGhoulAnimationData()
		{
			InitalizeStates();
			InitalizeAnimations();
		...
		public override void InitalizeAnimations()
		{
			_animationDatas = new List<Animation>()
			{
				...
				new Animation(Anim.ATK_Combo_1, 1, 1, 1),
		...
		public override void InitalizeTransitions()
		{
			_transitions = new List<Transition>()
			{
				...
				new Transition(
					Anim.Idle_Ground, Anim.ATK_Combo_1, 0.2f,
					(sd) => {
				...
				new Transition(
					Anim.Walk_Ground, Anim.ATK_Combo_1, 0.2f,
					(sd) => {
						return sd._toggleMap[Stat.Attack];
					}),
				...
				new Transition(
					Anim.Walk_Ground_Back, Anim.ATK_Combo_1, 0.2f,
					(sd) => {
						return sd._toggleMap[Stat.Attack];
					}),
				...
				//// ATK_Combo_1
				new Transition(
					Anim.ATK_Combo_1, Anim.Death_Ground, 0.05f,
					(sd) => {
						return sd._boolMap[Stat.Death];
					}),

				new Transition(
					Anim.ATK_Combo_1, Anim.Stagger_Weak, 0.05f,
					(sd) => {
						return sd._toggleMap[Stat.WeakStagger];
					}),

				new Transition(
					Anim.ATK_Combo_1, Anim.Stagger_Med, 0.05f,
					(sd) => {
						return sd._toggleMap[Stat.MedStagger];
					}),

				new Transition(
					Anim.ATK_Combo_1, Anim.Stagger_Strong, 0.05f,
					(sd) => {
						return sd._toggleMap[Stat.StrongStagger];
					}),

				new Transition(
					Anim.ATK_Combo_1, Anim.Idle_Ground, 0.05f,
					(sd) => {
						return sd._current.completed;
					}),
			};
