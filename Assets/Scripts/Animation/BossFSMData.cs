	...
	public class BossFSMData : FSMData
	{
		...
		public override void InitalizeAnimations()
		{
			_animationDatas = new List<Animation>()
			{
				...
				new Animation(Anim.Retreat, 1f, 0, 0, true, false, true, false),
				new Animation(Anim.Slash1, 1f, 1, 0, true, false, true, false),
				new Animation(Anim.Slash2, 1f, 1, 0, true, false, true, false),
				new Animation(Anim.Combo2_1, 1f, 1, 0f, true, false, true, false),
				new Animation(Anim.Combo2_2, 1f, 1, 0f, true, false, true, false),
				new Animation(Anim.Combo2_3, 1f, 1, 0f, true, false, true, false),
				new Animation(Anim.Combo3_1, 1f, 1, 0f, true, false, true, false),
				new Animation(Anim.Combo3_2, 2f, 1, 0f, true, false, true, false),
				new Animation(Anim.Combo3_3, 1f, 1, 0f, true, false, true, false),
				new Animation(Anim.Death, 1f, 1, 0f, true, false, true, false),
			};
		}
