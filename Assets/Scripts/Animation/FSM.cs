...
namespace TripleBladeHorse.Animation
{
    public class FSM : MonoBehaviour
    {
        ...
        private void Initialization()
        {
            ...
            stateData._intMap.Add(_data._intState);
            stateData._boolMap.Add(_data._boolState);
            stateData._floatMap.Add(_data._floatState);
            stateData._toggleMap.Add(_data._toggleState);
