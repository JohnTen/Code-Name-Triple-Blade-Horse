...
namespace BTAI
{
    ...
    public static class BT
    {
        ...
        public static BTAction RunCoroutine(Func<IEnumerator<BTState>> coroutine) { return new BTAction(coroutine); }
        public static BTAction Call(Action fn) { return new BTAction(fn); }
        public static ConditionalBranch If(Func<bool> fn) { return new ConditionalBranch(fn); }
        public static While While(Func<bool> fn) { return new While(fn); }
    ...
    public class BTAction : BTNode
    {
        ...
        public BTAction(Action fn)
        {
            this.fn = fn;
        }
        public BTAction(Func<IEnumerator<BTState>> coroutineFactory)
        {
